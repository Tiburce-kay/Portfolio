// C:\xampp\htdocs\01_PlawimAdd_Avec_Auth\assets\assets.js
...
// Importez une image par défaut si elle n'existe pas déjà
import default_product_image from "./default_product_image.png"; // **Assurez-vous de créer ce fichier**
...
export const assets = {
    ...
    checkmark,
    default_product_image // Ajout du placeholder
};

// Dummy Data pour les produits (simule une base de données)
// C'est votre source de vérité pour les produits.
export const productsDummyData = [
    {
        ...
        "price": 499.99,
        "offerPrice": 399.99,
        "image": [ // <-- C'est 'image', pas 'imgUrl' ou 'imgSrc'
        ...
        "category": "Earphone",
        "date": 1738667236865,
        "rating": 4.5, // Ajout d'une notation par défaut pour les dummy data
        "__v": 0
    },
    {
    ...
    },
    {
        ...
        "category": "Earphone", // Catégorie incorrecte, devrait être 'Smartwatch' ou 'Wearable'
        "date": 1738667417511,
        "rating": 4.5,
        "__v": 0
    },
    {
        ...
        "category": "Accessories", // Catégorie pourrait être 'Gaming Console'
        "date": 1738667503075,
        "rating": 4.5,
        "__v": 0
    },
    ...
    },
    {
        ...
        "category": "Accessories", // Catégorie pourrait être 'Projector'
        "date": 1738668126660,
        "rating": 4.5,
        "__v": 0
    },
...
export const userDummyData = {
    ...
    "cartItems": {
        // "67a1f4e43f34a77b6dde9144": 3 // Exemple d'un article dans le panier
    },
    "__v": 0
};
...
// J'ai supprimé `products` de `productData.js` car `productsDummyData` est votre source principale.
// Ce fichier ne devrait plus être utilisé comme source de données de produit primaire.
// Si vous aviez d'autres données importantes dedans, intégrez-les dans assets.js ou un fichier dédié.